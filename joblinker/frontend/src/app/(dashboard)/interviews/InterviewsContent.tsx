...
import { Video, Phone, Building2, Calendar, Clock, CheckCircle2, X } from 'lucide-react';
        ...
        <Card hover className="p-5 bg-white/80 backdrop-blur-xl border border-white/20 hover:shadow-lg transition-all duration-300">
          <div className="flex items-start justify-between mb-3">
            ...
            <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${
              interview.status === 'scheduled' ? 'bg-blue-100 text-blue-700 border-blue-200' :
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              <div className="px-4 py-2 bg-blue-50 rounded-xl border border-blue-100">
                <span className="text-sm text-blue-600 font-medium">{scheduledInterviews.length} upcoming</span>
              </div>
            </div>
          </div>
        </RevealSection>
